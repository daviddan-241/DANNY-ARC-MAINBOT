...
BOT_NAME = os.getenv("BOT_NAME", "ARC").strip() or "ARC"
...
BOT_COMMANDS = [
    ...
    ("services", "Promo services: volume, trending, ads, boosts"),
    ("myorders", "Your service orders and status"),
    ("balance", "Balances across your wallets"),
    ("docs", "Read the docs"),
    ("faq", "Frequently asked questions"),
    ("tutorial", "How to use ARC"),
